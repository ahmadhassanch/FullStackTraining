...
export class DateTimePickerComponent implements OnInit, OnDestroy, OnChanges, MatFormFieldControl<string>   // DoCheck
{
    static nextId = 0;
    ...
    @ViewChild('dateTimePanel') dateTimePanel: ChiPanelComponent;
    ...
    get formatDate() {
        return FORMATS.datetime(this.field.value);
    }
...
//    }
    ...
    @HostBinding()
    id = `chi-datetime-picker-${DateTimePickerComponent.nextId++}`;
